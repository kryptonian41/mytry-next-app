...
const AccountHome = () => {
  ...
  const { data: orders, isLoading, isError } = useQuery("userorders", getOrders,
    {
  ...
  return (
    <Layout title="My Account">
      <div className="h-full pb-8" style={{
        ...
        <div className="userpanel w-11/12 m-auto p-6 sm:p-12 mt-10 sm:mt-20 grid grid-cols-12" style={{
