  ...
  return (
    <React.Fragment>
      ...
      <div className="py-16">
        ...
        >
          100% Vegan | Responsibly Sourced Ingredients & Materials | Handcrafted
          + Highly Effective
        </p>
        ...
        <div className="pt-10 pb-20 grid grid-cols-1 sm:grid-cols-2 gap-x-40 border-t border-gray-800 w-5/6 m-auto mt-12">
          ...
          >
            ...
            >
              ...
              tempora dolorum hic ipsa corrupti consequuntur sequi ipsum, enim,
              eum ea earum molestias cupiditate culpa voluptas? Voluptatum
              blanditiis dolores ex modi pariatur tempore illum voluptate veniam
              ratione temporibus ad praesentium cum accusantium numquam,
              accusamus at aliquid eligendi! Eveniet accusamus provident tempore
              sapiente similique quam alias amet neque! Consequuntur, nam quia?
              <br />
              <br />
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nam rem
              voluptas cum consequuntur exercitationem quis rerum blanditiis
              perferendis, cumque tenetur.
            </span>
          </p>
