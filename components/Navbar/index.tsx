...
const Navbar: React.FC<Props> = ({ color = "dark", itemsCount, className }) => {
  ...
  useLayoutEffect(() => {
    window.matchMedia('(max-width: 640px)').addEventListener('change', ({ matches }) => {
    ...
    >
      <div className="space-x-6 flex items-center flex-wrap">
        <div className="cursor-pointer relative">
          ...
          {
            mobileView && showNavMenu && <ul className="absolute space-y-2 pt-4">
              <li className="whitespace-nowrap"><Link href="/products">Products</Link></li>
              <li className="whitespace-nowrap"><Link href="/about">About Us</Link></li>
              <li className="whitespace-nowrap"><Link href="/contact">Contact Us</Link></li>
              <li className="whitespace-nowrap"><Link href="/login">Log In</Link></li>
              <li className="whitespace-nowrap"><Link href="/register">Register</Link></li>
            </ul>
          }
